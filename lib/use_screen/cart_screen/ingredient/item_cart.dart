import 'package:dbmallhome/data/cartData/CartData.dart';
...
class item_cart extends StatefulWidget {
  ...
  const item_cart({super.key, required this.cartdata});
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Container(
                          alignment: Alignment.centerLeft,
                          child: Text(
                            getStringNumber(widget.cartdata.product.costBeforeSale) + ' .usd',
                            textAlign: TextAlign.start,
                            style: TextStyle(
                              fontFamily: 'muli',
                              color: Colors.grey,

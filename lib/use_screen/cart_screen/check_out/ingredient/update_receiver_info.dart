...
class _update_receiver_infoState extends State<update_receiver_info> {
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(finaldata.mainlanguage.UpdateReceiver, style: TextStyle(fontFamily: 'muli', fontSize: width/25, fontWeight: FontWeight.bold),),
      ...
      content: Container(
        ...
        child: ListView(
          children: [
            ...
            SizedBox(
              height: 50,
              child: edit_text_in_signup_step_1(controller: districtController, hint: finaldata.mainlanguage.Enteryourdistrict, event: () {setState(() {});  },),
            ),
            ...
            SizedBox(
              height: 50,
              child: edit_text_in_signup_step_1(controller: cityController, hint: finaldata.mainlanguage.Enteryourcity, event: () {setState(() {});  },),
            ),
            ...
            SizedBox(
              height: 50,
              child: edit_text_in_signup_step_1(controller: provinceController, hint: finaldata.mainlanguage.Enteryourprovince, event: () {setState(() {});  },),
            ),
            ...
            SizedBox(
              height: 50,
              child: edit_text_in_signup_step_1(controller: nationController, hint: finaldata.mainlanguage.Enteryournation, event: () {setState(() {});  },),
            ),
            ...
            SizedBox(
              height: 50,
              child: edit_text_in_signup_step_1(controller: podCodeController, hint: finaldata.mainlanguage.Enteryourpodcode, event: () {setState(() {});  },),
            ),
            ...
            SizedBox(
              height: 50,
              child: edit_text_in_signup_step_1(controller: phoneController, hint: finaldata.mainlanguage.EnteryourphoneNum, event: () {setState(() {});  },),
            ),
            ...
            SizedBox(
              height: 50,
              child: edit_text_in_signup_step_1(controller: addressController, hint: finaldata.mainlanguage.Enterspecificaddress, event: () {setState(() {});  },),
            ),
          ],
        ),
      ),
      actions: <Widget>[
        ...
        TextButton(
          ...
          child: Text(
            finaldata.mainlanguage.closeform,
            style: TextStyle(

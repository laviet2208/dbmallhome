...
class item_product_in_category_simple extends StatefulWidget {
  final Product product;
  const item_product_in_category_simple({super.key, required this.product});

  @override
  State<item_product_in_category_simple> createState() => _item_product_in_category_simpleState();
}

class _item_product_in_category_simpleState extends State<item_product_in_category_simple> {
  String url = '';

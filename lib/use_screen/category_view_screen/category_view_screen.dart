...
import 'package:dbmallhome/use_screen/category_view_screen/category_view_controller.dart';
import 'package:dbmallhome/use_screen/category_view_screen/ingredient/category_view_appbar.dart';
import 'package:dbmallhome/use_screen/category_view_screen/ingredient/item_product_in_category.dart';
...
class category_view_screen extends StatefulWidget {
  final ProductType productType;
  final Widget beforewidget;
  const category_view_screen({super.key, required this.productType, required this.beforewidget});

  @override
  State<category_view_screen> createState() => _category_view_screenState();
}

class _category_view_screenState extends State<category_view_screen> {
  ...
  Future<void> _refresh() async {
    ...
    productList = await mainPageController.get_product_list_by_type_id(widget.productType.id, () {setState(() {loading = false;});});
    setState(() {
    ...
    return WillPopScope(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: category_view_appbar(name: widget.productType.name,),
        ),

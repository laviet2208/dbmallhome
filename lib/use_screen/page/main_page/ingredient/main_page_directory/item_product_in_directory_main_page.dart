...
class item_product_in_directory_main_page extends StatefulWidget {
  final String id;
  const item_product_in_directory_main_page({super.key, required this.id});

  @override
  State<item_product_in_directory_main_page> createState() => _item_product_in_directory_main_pageState();
}

class _item_product_in_directory_main_pageState extends State<item_product_in_directory_main_page> {
  String url = '';

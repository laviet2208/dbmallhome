...
class item_main_page_product_type_2 extends StatefulWidget {
  final ProductType type;
  const item_main_page_product_type_2({super.key, required this.type});

  @override
  State<item_main_page_product_type_2> createState() => _item_main_page_product_type_2State();
}

class _item_main_page_product_type_2State extends State<item_main_page_product_type_2> {
  String url = '';
